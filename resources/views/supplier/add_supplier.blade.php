            ...
            <form action="{{route('suppliers.store')}}" method="POST" class="form-horizontal">
                ...
                <div class="row">
                    <div class="col-md-6"><br>
                        ...
                        <input name="supplier_name" type="text" id="supplier_name" placeholder="Supplier Name" class="form-control @error('supplier_name') is-invalid @enderror" value="{{old('supplier_name')}}">
                        @error('supplier_name')
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <input name="supplier_code" type="number" id="supplier_code" placeholder="Supplier Code" class="form-control @error('supplier_code') is-invalid @enderror" value="{{old('supplier_code')}}">
                        @error('supplier_code')
                            <div class="alert text-danger">{{$message}}</div>
                        @enderror
                    </div><br>
                    <div class="col-md-6"><br>
                        ...
                        <input name="phone_no" type="number" id="phone_no" placeholder="Contact Person" class="form-control @error('phone_no') is-invalid @enderror" value="{{old('phone_no')}}">
                        @error('phone_no')
                            <div class="alert text-danger">{{$message}}</div>
                        @enderror
                    </div><br>
